...
#    Updated: 2022/11/17 11:04:38 by lboulatr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS    =    ft_isascii.c    ft_memcmp.c    ft_putendl_fd.c    ft_strdup.c    ft_strlen.c    ft_substr.c    \
            ...
            ft_memchr.c    ft_putchar_fd.c    ft_strchr.c    ft_strlcpy.c    ft_strtrim.c    ft_strncmp.c    ft_atoi.c ft_lstsize.c    ft_lstnew.c    ft_lstlast.c    ft_lstadd_front.c    ft_lstadd_back.c    ft_lstdelone.c    \
